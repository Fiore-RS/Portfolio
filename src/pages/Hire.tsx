...
const webPackages: Package[] = [
  ...
  },
  {
    ...
    price: '$500',
    description: {
      en: 'Personal tools, trackers, or small platforms with auth and a database, like Teleo or Book Tracker. Does not cover large-scale apps (e-commerce, payments, AI chat features, etc.).',
      es: 'Herramientas personales, rastreadores o plataformas pequeñas con autenticación y base de datos, como Teleo o Book Tracker. No incluye aplicaciones a gran escala (compras en línea, pagos, chats de asistente con IA, etc.).',
    },
  },
]
